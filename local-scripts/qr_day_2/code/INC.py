...
# --- 2. ฟังก์ชันสแกนอ่าน QR Code จากภาพพร้อม Multi-Pass & OCR Fallback ---
...
def process_qr_codes(folder_path):
    ...
    # Fallback map สำหรับรูปที่ QR เสีย/เบลอมากๆ แต่อ่านข้อมูลนักศึกษาจากรูปได้
    OCR_MANUAL_MAP = {
        'LINE_ALBUM_INC 67 diwa_260728_25.jpg': 'U89aed919e73a7085d5c3dda790f38aa4', # ณหฤทัย ปล้องชู 69070501274
        'LINE_ALBUM_INC 67 diwa_260728_27.jpg': 'Ud66dc9694ac9b8453b6d92a0fc6d4d0b', # ปาณัทพงษ์ อินตะนัย 69070501256
        'LINE_ALBUM_INC 67 diwa_260728_79.jpg': 'U6c072d8861b64a4697fbbdcbd3d8c951', # ธนวัฒน์ ใจหลัก 69070501250
        'LINE_ALBUM_INC 67 diwa_260728_76.jpg': 'Uf46953f64b66c2c4dc3de0b314e9517a', # ดนภัทร บุญทารักษ์ 69070501214
    }
    ...
    for filename in image_files:
        ...
        if not qr_data and filename in OCR_MANUAL_MAP:
            qr_data = OCR_MANUAL_MAP[filename]
...
if not os.path.exists(TARGET_FOLDER):
    ...
    if normal_data or walkin_data:
        ...
        if not os.path.exists(key_path):
            ...
            DRY_RUN = True # กำหนด True เพื่อทดสอบอย่างเดียว หรือ False เพื่ออัพเดตลง Firestore จริง
